/******************************************************************************
  ...
  Development environment specifics:
    ...
    Micro OLED Breakout: https://www.sparkfun.com/products/13003
...
// When using SPI in v1.3, we still need to instantiate the oled like this
...
/*
  ...
  // You can still do it this way if you want to use SPI as the port
